...
<body>
    <div class="container mt-4 mb-5">
        ...
        <!-- Menu de Navegação Superior (Voltar ao Cadastro / Início) -->
        <div class="d-flex justify-content-between align-items-center mb-4">
            <a href="cadastrar_produto.php" class="btn btn-primary">+ Cadastrar Novo Produto</a>
            <a href="index.php" class="btn btn-outline-secondary">Sair / Início</a>
        </div>

        <!-- Cabeçalho com o Botão para Gerar Planilha -->
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3>Produtos Cadastrados:</h3>
            <a href="gerar_planilha.php" class="btn btn-success">Gerar Planilha</a>
        </div>

        <!-- Tabela com Estrutura Original do Git -->
                    ...
                    <?php if (!empty($produtos) && is_array($produtos)): ?>
                        <?php foreach ($produtos as $item): ?>
                            <tr>
                                ...
                                <!-- Botões usando os arquivos originais do Git: produto_alterar.php e remover_produto.php -->
                                <td class="text-right">
